function bookmark() {
		...
		{
		var url="http://xander6669.com/girls/index.php";
		var title="Idiot!";
...
function openWindow(url){
        aWindow = window.open(url,"_blankmenubar=no,status=no,toolbar=noresizable=no,width=180,height=175,titlebar=no,alwaysRaised=yes');
}
